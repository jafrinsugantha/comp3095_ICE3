...
class ProductServiceApplicationTests extends AbstractContainerBaseTest {
    ...
    void createProduct() throws Exception {
        ...
        String productRequestJsonStrong = objectMapper.writeValueAsString(productRequest);

        mockMvc.perform(MockMvcRequestBuilders.post("/api/product")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(productRequestJsonStrong))
    ...
    */
    ...
    void updateProducts() throws Exception {
        ...
        //prepare updated product in product request
